...
//Creando la pagina web con cadenas usando la sintaxis HERE DOC
echo "<!DOCTYPE html>";
echo "<html>";
echo "<head>";
...
echo '<script src="htttps://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>';
echo '<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootsrap.min.js"></script>';
echo "</head>";
echo "<body>";
...
foreach ($materias as $materia => $notas) {
    ...
    echo "</tr>";
    echo "<tr class='bg-success'></tr>";
    echo "  <th scope='col'>Nombres</th>";
    echo "  <th scope='col'>Nota</th>";
    echo "</tr>";
    echo "</thead>";
    echo "<tbody>";
    //Variable contador para determinar cuanto alumnos en total hay en cada materia
    $totalalumnos = 0;
    $sumanotas = 0;
    ...
    //Obtener la suma total de las notas entre el total de notas en la maeria procesada actualmente
