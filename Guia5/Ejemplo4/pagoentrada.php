...
<body>
    ...
    if (isset($_POST['comprar'])) {
        ...
        //Iniciando la tabla con la informacion de la pelicula seleccionada
    ?>
        <div class="container">
            <header class='navbar navbar-dark bg-dark'>
                <a class='navbar-brand' class='d-inline-block align-top' href='#'>Informacion del Formulario</a>
            </header>
            <table id="hor-zebra" class="table" summary="Datos recibidos del formulario">
                ...
                <tbody>
                <?php
                //Obteniendo los datos de la pelicula seleccionada que esta almacenada en $seleccionada
                $table = "";
                $i = 1;
            ...
            <a href="ejemplo4.php">Ingresar otra Pelicula</a>
        </div>
</body>
