...
<body>
    <div class="container">
        ...
        <section>
            <?php
            //Creamos una variable con el directorio o carpeta que continene las imagenes
            $dir = "img";
            //Creamos una matriz con los nombres de las imagenes que se almacenan en el directorio
            $peliculas = array(
                "al-diablo-con-el-diablo.jpg", "click.jpg", "cruzada.jpg", "efecto-mariposa.jpg", "busca-de-la-felicidad.jpg", "amenaza-fantasma.jpg",
                "la-milla-verde.jpg", "la-propuesta.jpg", "comunidad-del-anillo.jpg", "sexto-sentido.jpg", "Avengers.jpg", "Parasite.jpg"
            );
            ...
            <form action="pagoentrada.php" method="POST">
                <fieldset class="form-group">
                    ...
                    <select class="form-control" name="pelicula" id="pelicula">
                        ...
                        <option value="mov0006">La amenaza fantasma</option>
