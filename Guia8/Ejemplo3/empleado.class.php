<?php
//Definincion de la clase empleado
class empleado
{
    //Estableciendo las propiedas de la clase
    ...
    //Se inicializan porque peretencen a la clase
    const descISSS = 0.03;
    ...
    function obtenerSalarioNeto($nombre, $apellido, $salario, $horasextras, $pagoxhoraextra = 0.0)
    {
        ...
        //De acuerdo a criterios del Ministerio de Hacienda el descuento de la renta varia segun el ingreso percibido
    ...
    function imprimirBoletaPago()
    {
        ...
        $tabla .= "<tr class='success'><td colspan=\"2\"><h4>Descuentoss</h4></td></tr>";
        ...
        $tabla .= "<tr><td>Sueldo Liquido a Pagar: </td>";
