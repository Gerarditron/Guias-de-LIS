    ...
    <section id="slick">
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($x1 == "Error" || $x2 == "Error" || $y1 == "Error" || $y2 == "Error") {
                die("<h3 style=\"color:red;\">Los valores de x1, x2, y1 y y1 deben ser numericos</h3>");
            }
            ...
            printf("<p class=\"resp\">D = sqrt((x<sub>2</sub>-x<sub>1</sub>)<sup>2</sup>+(y<sub>2</sub>-y<sub>1</sub>)<sup>2</sup>)</p>\n");
            printf("<p class=\"resp\">D = sqrt((%5.2lf-%5.2lf)<sup>2</sup> + (%5.2lf-%5.2lf)<sup>2</sup>)</p>\n", $coord2->x, $coord1->x, $coord2->y, $coord1->y);
        } else {
            ...
            <div class="contact-form">
                ...
                <div class="w-100">
                    ...
                    <!-- <form name="frmrectangulo" id="frmrectangulo" action="javascript:void(0);"> -->
                        ...
                        <div class="field">
                            <input type="number" name="coordy1" id="coordy1" min="0" max="1000" steo=".1" placeholder="(y1)" required />
                            <span class="entypo-base icon"></span>
                        ...
                        <div class="field">
                            <input type="number" name="coordy2" id="coordy2" min="0" max="1000" steo=".1" placeholder="(y2)" required />
                            <span class="entypo-base icon"></span>
                            <span class="slick-tip left">Ingrese la coordenada y2:</span>
                        </div>
                        <!-- Botonoes para Hacer los Calculos -->
