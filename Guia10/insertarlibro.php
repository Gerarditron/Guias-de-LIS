...
<body class="container">
    <header>
        <nav class='nabar navbar-dark bg-primary'>
    ...
    <section>
        <article>
            <?php
            //Asignando los datos del formulario a variables locales con nombres cortos
            ...
            //Conectando con el servidor MySQL y seleccionando la base de datos con la que se trabajara
                ...
                <div class="row pager">
                    <div class="col-md-6 text-left">
                        <a href="menuopciones.html" class="d-block h3 font-weight-normal">Regresar<br>
                            <small class="d-block text-muted">Menu</small>
                        </a>
                    </div>
                    <div class="col-md-6 text-right">
                        <a href="nuevolibro.html" class="d-block h3 font-weight-nromal">Agregar<br>
                            <small class="d-block text-muted">Otro libro</small>
                        </a>
                    </div>
                </div>
            </section>
