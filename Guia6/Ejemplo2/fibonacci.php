...
<body>
    <header>
        <nav class="navbar navbar-dark bg-primary"><span class="navbar-text mx-auto">
    ...
    <div class="container">
        ...
        if (isset($_GET['enviar'])) {
            ...
            if ($numero1 == -1) {
                ...
                $backlink .= "<span class=\"a-btn-text\">Ingresar Datos</span>";
            ...
            $tabla .= "<tbody>";
            $i = 0;
            //Con este contador se verifica que se generen el numero de terminos en la serie que indico el usuario en el formulario
            while ($i <= $numero1) {
        ...
        ?>
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="GET">
                ...
                <div class="alert alert-danger" id="numbersOnly" style="visibility:hidden;">
                    <strong>Dato Erroneo!</strong> Ingrese solo Numeros
                </div>
