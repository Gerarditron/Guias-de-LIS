    ...
    <section>
        <article class="container">
            ...
            if (isset($_POST['btnContar'])) {
                //Se carga la libreria con la funcion que se encargara de contar las palabras en el texto ingresado por el usuario
                require "wordcount.php";
                $textolimpio = wordcount($_POST['area']);
                $complemento = count($textolimpio) > 1 ? "palabras" : "palabra";
                echo "<p>Se han contabilizado: " . count($textolimpio) . "</p>\n";
            } else {
            ?>
